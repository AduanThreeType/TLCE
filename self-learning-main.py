...
torch.save(MLP_model.state_dict(), f'./saved_models/self_learning_{DATA}_model_MLP.pth')
print("MLP_model save over")
torch.save(tatkc.state_dict(), f'./saved_models/self_learning_{DATA}_model_tatkc.pth')
