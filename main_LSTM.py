...
tatkc = TRTKC(train_real_ngh_finder[0], test_real_feat, num_layers=NUM_LAYER, use_time=USE_TIME,
...
torch.save(MLP_model.state_dict(), './saved_models/model_MLP_LSTM.pth')
print("MLP_model save over")
torch.save(tatkc.state_dict(), './saved_models/model_tatkc_LSTM.pth')
