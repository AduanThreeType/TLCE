...
class NeighborFinder:
    def __init__(self, adj_list, uniform=False):
        ...
        self.node_idx_l = node_idx_l #入顶点集合
        self.node_ts_l = node_ts_l #入边时间戳集合
        self.edge_idx_l = edge_idx_l #入边索引集合

        self.off_set_l = off_set_l #偏移量 用于快速找到邻居节点
    ...
    #src_indx_l ->入节点的集合    cut_time_l-> 最大时间戳的集合
    ...
    def get_temporal_neighbor(self, src_idx_l, cut_time_l, num_neighbors=20):
        ...
        for i, (src_idx, cut_time) in enumerate(zip(src_idx_l, cut_time_l)):
            ...
            if len(ngh_idx) > 0:
                ...
                if len(ngh_idx) > num_neighbors: #如果总邻居长度大于所预定的上限
